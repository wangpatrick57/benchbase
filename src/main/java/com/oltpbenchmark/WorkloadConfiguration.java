...
public class WorkloadConfiguration {
    ...
    public void addPhase(int id, int time, int warmup, double rate, double replaySpeedup, List<Double> weights, boolean rateLimited, boolean disabled, boolean serial, boolean replaySpeedupLimited, boolean replay, boolean timed, int active_terminals, Phase.Arrival arrival, String logFilePath) {
        phases.add(new Phase(benchmarkName, id, time, warmup, rate, replaySpeedup, weights, rateLimited, disabled, serial, replaySpeedupLimited, replay, timed, active_terminals, arrival, logFilePath));
    }
